...
To install **Flask** and start developing a Flask web application, you need to follow these simple steps:

---

### **1. Install Python (if not already installed)**

Flask requires Python to run, so make sure you have Python installed on your system.

- **Download and Install Python**: 
  - Visit [Python's official website](https://www.python.org/downloads/) and download the latest version for your operating system.
...
It’s a good practice to create a **virtual environment** for your project. This isolates the dependencies and prevents conflicts with other Python projects.

#### For Windows:

1. Open your command prompt (cmd) or PowerShell.
2. Navigate to the folder where you want your Flask project.
...
When activated, the virtual environment's name (usually `venv`) will appear in your terminal prompt, indicating that it’s active.

---

### **3. Install Flask Using `pip`**

After activating the virtual environment, you can install Flask using **pip**, Python's package manager.
...
This will install the latest stable version of Flask and its dependencies.

---

### **4. Verify the Installation**

To ensure Flask has been installed successfully, you can run the following command:
```bash
pip show Flask
```

This will show information about the Flask package, including its version.
